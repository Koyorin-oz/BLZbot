/**
 * Déploiement manuel des commandes slash globales (/verify, /man-verify, /setup-verification, /unverify, /antiraid).
...
async function main() {
  ...
  console.log(
    '✅ Commandes globales enregistrées : /verify, /man-verify, /setup-verification, /unverify, /antiraid',
  );
}
